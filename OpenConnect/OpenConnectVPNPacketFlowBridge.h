...
@protocol OpenConnectVPNAdapterPacketFlow;

@interface OpenConnectVPNPacketFlowBridge: NSObject

@property (nonatomic, readonly) CFSocketRef openVPNSocket;
@property (nonatomic, readonly) CFSocketRef packetFlowSocket;

- (instancetype)init NS_UNAVAILABLE;
- (instancetype)initWithPacketFlow:(id<OpenConnectVPNAdapterPacketFlow>)packetFlow NS_DESIGNATED_INITIALIZER;

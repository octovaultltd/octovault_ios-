...
- (void)dismissAnimation:(BOOL)animation {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"StopNetSpeedNotification" object:nil];
}
...
//    CGRect modifiedFrame = contentRect;
//    modifiedFrame.origin.x = 0;
//    contentView.frame = modifiedFrame;
